...
{
	HAL_GPIO_WritePin(PORT_LED_0, PIN_LED_0, GPIO_PIN_SET);
	HAL_GPIO_WritePin(PORT_LED_1, PIN_LED_1, GPIO_PIN_SET);
	HAL_GPIO_WritePin(PORT_LED_2, PIN_LED_2, GPIO_PIN_SET);
}
